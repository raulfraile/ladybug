...
class Ladybug_Objects_Domdocument extends LadybugExtension  {
    ...
    public function dump($var) {
        ...
        // indentation
        $lines = explode(Ladybug::CHAR_NEWLINE, $xml);
        $result = '';
        foreach ($lines as $line) {
            
            if (strlen(trim($line)) > 0) {
                $result .= $this->ladybug->writeDepth() . $line . Ladybug::CHAR_NEWLINE;
            }
        }
